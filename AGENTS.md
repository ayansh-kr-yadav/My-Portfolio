# AI Agent Guidelines for https://ayansh.online

This guide provides essential information for AI agents working with the https://ayansh.online codebase - a Next.js dev portfolio, blog, and component registry website.

## Project Overview

**https://ayansh.online** is a minimal, pixel-perfect dev portfolio, component registry, and blog built with modern web technologies. It serves as:

- Personal portfolio for Ayansh Kr Yadav (@ayansh-kr-yadav)
