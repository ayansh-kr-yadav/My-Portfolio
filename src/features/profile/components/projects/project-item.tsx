import { Github, Globe, InfinityIcon, LinkIcon } from "lucide-react";
              ...
              <div className="flex gap-2">
                {project.githubLink && (
                  <a
                    ...
                    className="flex items-center gap-1.5 rounded-md border border-edge bg-background px-3 py-1.5 text-xs font-medium text-foreground hover:bg-muted"
                  >
                    <Github className="size-3.5" /> Code / GitHub
                  </a>
                )}
                {project.demoLink && (
                  <a
